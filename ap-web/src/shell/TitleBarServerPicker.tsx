 ...
 * owned by the web layer. This fills its center with "GameOps Agent — <host>" and
 ...
 *
 * When a thread is open, its title replaces the "GameOps Agent" brand label
...
export function TitleBarServerPicker({
  ...
  /** Title of the currently open thread, or null/undefined when no thread
      is selected or it has no title yet (falls back to "GameOps Agent"). */
      ...
      <DropdownMenu>
        ...
        >
          <span className="truncate font-medium">
            {threadTitle || "GameOps Agent"} — {hostOf(info.currentOrigin)}
          </span>
